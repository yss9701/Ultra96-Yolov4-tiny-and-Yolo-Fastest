...
def resblock_body(x, num_filters, num_filters_1):
    ...
    x = DepthwiseConv2D_BN_Leaky(num_filters, (3, 3))(x)
...
def darknet_body(x):
    ...
    x = DarknetConv2D_BN_Leaky(8, (3, 3), strides=(2, 2))(x)
    x = DarknetConv2D_BN_Leaky(8, (1, 1), strides=(1, 1))(x)
    #x = ZeroPadding2D(((1, 0), (1, 0)))(x)
    x = DepthwiseConv2D_BN_Leaky(8, (3, 3), strides=(1, 1))(x)
    ...
    x = ZeroPadding2D(((1, 0), (1, 0)))(x)
    x = DepthwiseConv2D_BN_Leaky(32, (3, 3), strides=(2, 2))(x)
    x = DarknetConv2D_BN_Leaky(8, (1, 1), strides=(1, 1))(x)
    x = resblock_body(x, 48, 8)
    x = resblock_body(x, 48, 8)
    x = DarknetConv2D_BN_Leaky(48, (1, 1), strides=(1, 1))(x)
    x = DepthwiseConv2D_BN_Leaky(48, (3, 3), strides=(1, 1))(x)
    ...
    x = ZeroPadding2D(((1, 0), (1, 0)))(x)
    x = DepthwiseConv2D_BN_Leaky(96, (3, 3), strides=(2, 2))(x)
    x = DarknetConv2D_BN_Leaky(24, (1, 1), strides=(1, 1))(x)
    ...
    feat1 = x
    x = ZeroPadding2D(((1, 0), (1, 0)))(x)
    x = DepthwiseConv2D_BN_Leaky(136, (3, 3), strides=(2, 2))(x)
    x = DarknetConv2D_BN_Leaky(48, (1, 1), strides=(1, 1))(x)
